...
const PeopleSay = () => {
    return (
        ...
        <div className="testimonials-header">
            ...
            <p className="description">You can visit our office anytime but please don't stalk us or don't be creepy.</p>
        </div>
        ...
        <div className="testimonials-grid">
            ...
            <div className="card">
                ...
                <p className="card-text">Lorem ipsum dolor sit amet, consectetur ad-zzz-ing elit. Proin vel urna at metus tempor mattis, or not, whatever.</p>
